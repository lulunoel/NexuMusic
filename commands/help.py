...
class HelpView(View):
    def __init__(self, help_command, context, mapping):
        ...
        exclude_cogs = ['ErrorHandler', 'LoggerHandler', 'ReadyHandler', 'JoinHandler', 'LeaveHandler', 'InviteManager', 'ConsoleCommandManager', 'DiscordLoggerHandler', 'MessageSuggestion', 'Voice']
